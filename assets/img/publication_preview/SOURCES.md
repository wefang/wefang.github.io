Publication thumbnails and their sources. Every image is from an open-access article, used under its license,
and shown beside the full citation of the article it comes from.

| file | article | figure | license |
|---|---|---|---|
| qfm.png | Fang et al., Cell 2022 | graphical abstract, from the authors' final submission files | Elsevier; author reuse |
| funcode.png | Fang et al., bioRxiv 2024 | Figure 1c, from the authors' figure files | authors' own figure |
| handler2025.png | Handler et al., Cell Reports 2025 (PMC12831586) | graphical abstract, unmodified | CC BY-NC-ND 4.0 |
